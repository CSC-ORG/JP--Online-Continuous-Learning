...
if(isset($_POST['submit'])){
             ...
             $query=mysqli_query($con,"INSERT INTO reviews values ('$name','$name1','$comment','$rating2')");
...
<!-- Form Name -->
<h1 class="intro-text text-center"><h2 class="intro-text text-center" class="text-danger" >YOUR REVIEW PLEASE!</h2></h1>
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="textinput" name="name1" placeholder="name" class="form-control input-md" required="" type="text">
  <span class="help-block">ex: sharang</span>  
  </div>
</div>

<!-- Textarea -->
<div class="form-group">
  <label class="col-md-4 control-label" for="textarea">REVIEW</label>
  <div class="col-md-4">                     
    <textarea type="text" class="form-control" id="textarea" name="review">REVIEW</textarea>
  </div>
</div>
<div class="form-group">
  <label class="col-md-4 control-label" for="textarea">RATING</label>
  <div class="col-md-4">                     
    <select name="rating2">
...
<!-- Button -->
<div class="form-group">
  <label class="col-md-4 control-label" for="Done">WRITE</label>
  <div class="col-md-4">
    <input type="submit" id="Done" name="submit" class="btn btn-info" value="Submit">
  </div>
</div>
