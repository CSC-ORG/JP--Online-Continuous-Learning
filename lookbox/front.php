<?php
  session_start();
      ...
      header('Location: ../product-quick-view/index1.php');
      } 
...
<div class="jumbotron text-center">
   <div class="row">
        <div class="col-sm-3">
<a href="csin.php" class="btn btn-info" role="button">Sigin company</a>		
		</div>
...
<div class="col-sm-3">
<a href="userlogin.php" class="btn btn-info" role="button">Sigin user</a>		
		</div>
...
<div id="sup" class="container-fluid text-center">
   ...
   <div class="col-sm-4">
   <h2>User</h2>
   <a href="" <img src="img/user.png" style="width:250px; height: 250px; ">
    </div> 
  <br>
